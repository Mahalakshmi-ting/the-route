...
<body class="events-page page-template">
                    ...
                    <div class="swiper">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a class="card-sec" href="pages/events/anirudh-concert.php">
                                    <div class="card-img">
                                        <img src="images/events/anirudh/anirudh-thumbnail.png" alt="Card"
                                            class="card-img" />
                                    </div>
                                </a>
                            </div>
                            ...
                            <!-- Slide 2 -->
                            <div class="swiper-slide">
                                <a class="card-sec" href="javascript:;">
                                    <div class="card-img">
                                        <img src="images/events/coming-soon.png" alt="Card" class="card-img" />
                                    </div>
